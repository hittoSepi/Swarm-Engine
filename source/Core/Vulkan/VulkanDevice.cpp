...
VulkanDevice::VulkanDevice(WindowBase* window, VkInstance &instance, VkSurfaceKHR &surface, const Options& opts) :
	Device(opts), window(window), instance(instance), surface(surface)
{
}
